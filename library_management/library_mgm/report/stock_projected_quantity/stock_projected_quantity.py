...
def get_columns():
    """تحديد الأعمدة التي ستظهر في التقرير"""
    return [
        ...
        {"label": _("Reserved for Production"), "fieldname": "reserved_qty_for_production", "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Reserved for Production Plan"), "fieldname": "reserved_qty_for_production_plan", "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Reserved for Sub Contracting"), "fieldname": "reserved_qty_for_sub_contract", "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Reserved for POS Transactions"), "fieldname": "reserved_qty_for_pos", "fieldtype": "Float", "width": 100, "convertible": "qty"},
        ...
        {"label": _("Item Image"), "fieldname": "image", "fieldtype": "Image", "width": 120}  # إضافة عمود الصورة
    ]


def get_bin_list(filters):
    """استرجاع قائمة البينات بناءً على الفلاتر"""
...
def get_item_map(item_code, include_uom):
    ...
    query = (
        ...
        .select(item.name, item.item_name, item.description, item.item_group, item.brand, item.stock_uom, item.image)
        .where(
